...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm">
        ...
        <!-- Submissions Tab -->
        <div id="submissionsContent" class="tab-content hidden p-6">
            <div class="bg-gray-50 rounded-lg p-6">
        ...
        <!-- Edit Requests Tab -->
        <div id="editRequestsContent" class="tab-content hidden p-6">
            <div class="bg-gray-50 rounded-lg p-6">
                ...
                <div class="border border-gray-200 rounded-lg p-4 bg-white">
                    <div class="flex justify-between items-start mb-2">
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Data Record ID: ${request.parent_id || request.data_record_id}</p>
                        </div>
...
<style>
    .tab-button {
        @apply py-4 px-6 text-sm font-medium text-gray-500 hover:text-gray-700 border-b-2 border-transparent hover:border-gray-300 transition duration-200;
    }
    .tab-button.active {
